...
from modules.db import ensure_directories, init_db
from modules.session import require_auth, sync_default_users
...
st.caption("v1.7 desarrollo: acceso real por rol Administrador / Chofer, modo chofer móvil y trazabilidad de capturas.")
