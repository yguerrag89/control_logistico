...
status_options = ["Abierta", "Cerrada pendiente de GPS", "GPS cargado", "Conciliada con GPS", "Validada", "Con incidencias"]
...
show_cols = [
    ...
    "hora_regreso_reportada", "estado_ruta", "entregas_capturadas", "observaciones_generales"
]
